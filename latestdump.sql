...
BEGIN
    ...
    UPDATE approvals
	SET associate_dean_Approval="Rejected",  associate_dean_Approval_time=_associate_dean_approval_time 
	WHERE form_name="Cover letter for new proposal" and application_no=_application_no;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2021-11-22 15:38:11
