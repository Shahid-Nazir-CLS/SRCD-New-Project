<%@ Page Title="" Language="C#" MasterPageFile="~/Application_Forms/Views/MasterPage.master" AutoEventWireup="true" CodeFile="view_approvals.aspx.cs" Inherits="Application_Forms_Views_view_approvals" %>
                ...
                <tbody>
                    <tr valign="top">
                        <td class="head_already" style="height: 30px">
                            <div style="text-align: center">
                                <span>
                                    <asp:Label ID="lbl_current_financial_year" runat="server" Text="Approvals"></asp:Label></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="height: 30px; text-align: center;" colspan="3">
                            <div align="center">
                                <asp:GridView ID="gvProduct" runat="server" Width="100%" CellSpacing="3" CellPadding="5" AutoGenerateColumns="False" BorderColor="#008080" BorderStyle="Solid" BorderWidth="1px" OnSelectedIndexChanged="gvProduct_SelectedIndexChanged">
                                    <Columns>
