...
Partial Class Department_Division_Users_PopUp_Webpages_Print_Form_A
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            'Atul lbl_budget_head_details.Text = budget_main_head.ToString() & "/" & budget_head.ToString & "/" & budget_sub_head.ToString & "/" & budget_head_description.ToString
            ...
            'Atul lbl_budget_head.Text = budget_main_head.ToString() & "/" & budget_head.ToString & "/" & budget_sub_head.ToString & "/" & budget_head_description.ToString
    ...
    Private Sub Bind_Item_Details_For_Form_A()
        ...
        Using con As New SqlConnection(constr)
            Dim str1 As String = "SELECT * FROM tbl_Individual_Consumables_form_Details WHERE FinancialYear='" & financial_year & "' and Approval_No = '" & reference_no.ToString() & "' AND Department_Id = '" & department_division_id.ToString() & "'  "
    ...
    Protected Sub GridView2_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs)
        ...
        If e.Row.RowType = DataControlRowType.Footer Then
            ...
            '  Dim lbl_total_amount_in_words As Label = DirectCast(e.Row.FindControl("lbl_total_amount_in_words"), Label)

        End If
        lbl_total_amount_in_words.Text = "<b>Total Amount in Words:  </b>" & " (" & "" & NumberInWords(items_total_amount_p) & " Only)"
