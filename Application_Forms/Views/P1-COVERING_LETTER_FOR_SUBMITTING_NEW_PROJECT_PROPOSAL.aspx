            ...
            <tr>
                <td>
                    ...
                    <asp:Image ID="imgCaptcha" runat="server" />
                         ...
                         <br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBox_captcha" ErrorMessage="Required" ForeColor="Red" style="margin-right:1%"></asp:RequiredFieldValidator>
